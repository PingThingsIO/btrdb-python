...
class ArrowInsertParams(_message.Message):
    __slots__ = ["arrowBytes", "merge_policy", "sync", "uuid"]
    ARROWBYTES_FIELD_NUMBER: _ClassVar[int]
    ...
    sync: bool
    uuid: bytes
    def __init__(self, uuid: _Optional[bytes] = ..., sync: bool = ..., merge_policy: _Optional[_Union[MergePolicy, str]] = ..., arrowBytes: _Optional[bytes] = ...) -> None: ...
