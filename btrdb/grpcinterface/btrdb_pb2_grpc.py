...
class BTrDBStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                request_serializer=btrdb__pb2.SubscriptionParams.SerializeToString,
...
def add_BTrDBServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=btrdb__pb2.SubscriptionParams.FromString,
...
class BTrDB(object):
    ...
    def Subscribe(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/v5api.BTrDB/Subscribe',
            btrdb__pb2.SubscriptionParams.SerializeToString,
